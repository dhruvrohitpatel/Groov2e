interface IP { s?: number; c?: string; glow?: boolean }

export const Icon = {
  Play: ({ s = 14, c = 'currentColor' }: IP) => (
    <svg width={s} height={s} viewBox="0 0 14 14" fill="none"><path d="M3 2L12 7L3 12V2Z" fill={c}/></svg>
  ),
  Pause: ({ s = 14, c = 'currentColor' }: IP) => (
  ...
  Metronome: ({ s = 14, c = 'currentColor' }: IP) => (
  ...
  Scissors: ({ s = 12, c = 'currentColor' }: IP) => (
  ...
  Lamp: ({ s = 22, c = 'currentColor', glow = false }: IP) => (
    <svg width={s} height={s} viewBox="0 0 32 24" fill="none">
      ...
      <path d="M8 18 C6 18 5 16.5 5 14.5 C5 11 8 8 13 8 L18 8 C19 8 20 8.3 21 9 L26 7 L25 11 L24.5 12 C25.5 13 26 14 26 15.5 C26 17 25 18 23 18 L8 18 Z" fill={c} stroke="#1a1210" strokeWidth="0.6"/>
  ...
  Smoke: ({ s = 32, c = '#2340E8' }: IP) => (
    <svg width={s} height={s * 2} viewBox="0 0 32 64" fill="none">
      <path d="M26 58 Q28 50 24 44 Q20 38 24 30 Q28 22 22 14 Q18 8 22 2" stroke={c} strokeWidth="2" fill="none" opacity="0.4" strokeLinecap="round"/>
      <path d="M26 58 Q29 52 26 46 Q22 40 27 32 Q30 24 26 16" stroke={c} strokeWidth="3" fill="none" opacity="0.2" strokeLinecap="round"/>
    </svg>
  ),
};
